    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="Site Name"  name="siteName"  value={settings.siteName || ''} onChange={change} placeholder="Azerbaijan Tourism" />
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="space-y-4">
          <Field label="Meta Title"       name="metaTitle"       value={settings.metaTitle || ''}       onChange={change} placeholder="Azerbaijan Tourism — Land of Fire" />
          <div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="Contact Email"   name="contactEmail"   value={settings.contactEmail || ''}   onChange={change} type="email" placeholder="hello@azerbaijantourism.az" />
          <Field label="Contact Phone"   name="contactPhone"   value={settings.contactPhone || ''}   onChange={change} placeholder="+994 12 000 0000" />
          <div className="sm:col-span-2">

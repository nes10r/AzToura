...
const PAGES = [
  { name: 'Home', path: '/', title: 'aztoura', desc: 'Discover Azerbaijan destinations', keywords: 'azerbaijan, tourism, baku, aztoura' },
  ...
  { name: 'About', path: '/about', title: 'About Us', desc: 'About aztoura', keywords: 'about, team' },
];
